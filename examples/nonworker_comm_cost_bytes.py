...
stage1.init(stage_cls=CamSource, cls_args=cam_source_args, stage_type=SRC, itypes=[None], otype=BYTES)
stage2.init(stage_cls=Mid, cls_args={}, stage_type=NOR, itypes=[BYTES], otype=BYTES)
stage3.init(stage_cls=Mid, cls_args={}, stage_type=NOR, itypes=[BYTES], otype=BYTES)
stage4.init(stage_cls=Sink, cls_args={}, stage_type=DST, itypes=[BYTES], otype=None)
